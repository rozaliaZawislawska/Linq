...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = Emps
                .Join(Depts, 
                    e => e.Deptno,
                    d => d.Deptno,
                    (Emps, Depts) => new { ename = Emps.Ename, job = Emps.Job, dname = Depts.Dname });
        ...
        public static IEnumerable<object> Task7()
        {
            IEnumerable<object> result = Emps
                .GroupBy(e => e.Job)
                .Select(e => new{Job = e.Key, count = e.Count()});
            return result;
        }
        ...
        {
            bool result = Emps.Any(e => e.Job == "Backend Developer");
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps
                .GroupBy(e => e.Deptno)
                .Where(e => e.Count() > 1)
                .Join(Depts, e => e.Key, d => d.Deptno, (e, d) => new { name = d.Dname, numOfEmployees = e.Count() });
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Emps
                .GroupBy(e => e.Deptno)
                .Where(e => e.Count() == 5 || e.Count() == 0 )
                .Join(Depts, e => e.Key, d => d.Deptno, (e, d)=>d)
                .OrderByDescending(d=>d.Dname);
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.SelectMany(e => Depts.Select(d => new { e, d }));
